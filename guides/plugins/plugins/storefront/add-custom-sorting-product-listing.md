...
You should also have a look at our [Database migrations](database-migrations.md) guide, as we use one in this guide.
...
You can subscribe to the `ProductListingCriteriaEvent` to add a `ProductSortingEntity` as available sorting on the fly. If you don't know how to do this, head over to our [Listening to events](listening-to-events.md) guide.
