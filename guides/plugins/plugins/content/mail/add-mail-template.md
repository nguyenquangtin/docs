...
Furthermore, this guide will use [database migrations](database-migrations.md) in order to add a custom mail template, which is not explained in depth here. Make sure to understand those first!
