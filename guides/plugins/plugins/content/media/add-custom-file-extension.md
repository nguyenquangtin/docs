...
Furthermore, you'll have to know about adding classes to the [dependency injection](dependency-injection.md) container
and about using a subscriber in order to [listen to events](listening-to-events.md).
...
This is of course done via a [subscriber](listening-to-events.md).
...
Make sure to register your new type detector to the [dependency injection container](dependency-injection.md)
