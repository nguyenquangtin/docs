...
For this guide, you'll need a working plugin, which you learn to create [here](plugin-base-guide.md). Also, you'll have to know the [Dependency Injection container](dependency-injection.md), since that's going to be used in order to register your custom validator.
...
One more thing to do is to register your new validator to the [dependency injection container](dependency-injection.md).
...
First of all you should know our guide about [adding storefront snippets](add-translations.md), since that won't be explained in detail here.
