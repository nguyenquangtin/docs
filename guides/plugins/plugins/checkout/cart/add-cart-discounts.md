...
Furthermore you should be familiar with the service registration in Shopware, otherwise head over to our [Add custom service](SHOPWARE/docs/guides/plugins/plugins/plugin-fundamentals/add-custom-service.md) guide.
