...
Considering that the data handling in the administration is remotely operating the Data Abstraction Layer its highly encouraged to read the articles [Reading data with the DAL](reading-data.md) and [Writing data with the DAL](writing-data.md).
