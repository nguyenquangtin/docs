...
Furthermore you should have a look at our [Listening to events](listening-to-events.md) guide since we are subscribing to events in this guide.
...
After creating the event subscriber, you have to register it. If you don't know how that's done, head over to our guide about [Listening to events](listening-to-events.md).
