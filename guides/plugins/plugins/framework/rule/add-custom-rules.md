...
You also should be familiar with the [Dependency Injection container](dependency-injection.md) as this is used to register your custom rule.

It might be helpful to gather some general understanding about the [concept of rules](rules.md) as well.
