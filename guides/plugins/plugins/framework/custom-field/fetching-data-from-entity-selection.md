...
This guide will not explain how to create custom field in general, so head over to the official guide about [custom field](SHOPWARE/docs/guides/plugins/plugins/framework/custom-field/add-custom-field.md) to learn this first.
